...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"firebase/firebaseConfig.js":[function(require,module,exports) {
"use strict";
...
},{}],"firebase/firebase.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.saveScore = exports.scoresRef = void 0;
...
var scoresRef = dbRef.child('typeScores');
exports.scoresRef = scoresRef;

var saveScore = function saveScore(highScoresArray, name, score) {
  highScoresArray.push({
    name: name,
    score: score
  });
  highScoresArray = highScoresArray.sort(function (a, b) {
    return b.score - a.score;
  });
  highScoresArray.splice(10);
  scoresRef.set(JSON.stringify(highScoresArray), function () {
    changeScreen(0);
  });
};

exports.saveScore = saveScore;
},{"./firebaseConfig":"firebase/firebaseConfig.js"}],"auth/utils.js":[function(require,module,exports) {
"use strict";
...
},{}],"utils/navigation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.isScreenShowing = exports.changeScreen = void 0;
...
var screens = _toConsumableArray(document.querySelectorAll('.screen')); // 0 - home, 1 - game, 2 - end


var changeScreen = function changeScreen(screenIndex) {
  var isPlaying = screenIndex === 1 ? true : false;
...
var isScreenShowing = function isScreenShowing(screenIndex) {
  var screen = screens[screenIndex];
  return !screen.classList.contains('hidden');
};

exports.isScreenShowing = isScreenShowing;
...
highScoresBtn.addEventListener('click', function () {
  (0, _navigation.changeScreen)(3);
}); //Game Screen

var titleText = document.getElementById('titleText');
var timerText = document.getElementById('timer');
var randomCharacterText = document.getElementById('randomCharacter');
var scoreText = document.getElementById('scoreText'); //game state
...
var highScoresArray = []; //high scores screen

var scoresToHomeBtn = document.getElementById('scoresToHomeBtn');
scoresToHomeBtn.addEventListener('click', function () {
  console.log('going home');
  (0, _navigation.changeScreen)(0);
}); //Auth Stuff!
...
_firebase.scoresRef.on('value', function (snapshot) {
  console.log(snapshot.val());
  highScoresArray = JSON.parse(snapshot.val()).sort(function (record1, record2) {
    return record2.score - record1.score;
  });
  highScores.innerHTML = '';
  highScoresArray.forEach(function (score) {
    var scoreLI = document.createElement('li');
    scoreLI.innerText = "".concat(score.name, " - ").concat(score.score);
...
var getRandomCharacter = function getRandomCharacter() {
  ...
  var randomInt = Math.floor(Math.random() * 36);
...
var startGame = function startGame() {
  ...
  var timerInterval = setInterval(function () {
    ...
    if (seconds <= 0 && ms <= 0) {
      ...
      endScoreText.innerText = "SCORE: ".concat(score);
      isPlaying = (0, _navigation.changeScreen)(2);
    }

    displayFormattedTimer(seconds, ms);
  }, 16.67);
  isPlaying = (0, _navigation.changeScreen)(1);
};
...
var displayFormattedTimer = function displayFormattedTimer(seconds, ms) {
  var formattedSeconds = ('0' + seconds).slice(-2);
  var formattedMs = ('0' + ms).slice(-2);
  timerText.innerText = "".concat(formattedSeconds, ":").concat(formattedMs);
};

document.addEventListener('keyup', function (e) {
  if ((0, _navigation.isScreenShowing)(0) && e.key === 's') {
    return startGame();
  }
  ...
  scoreText.innerText = "SCORE: ".concat(score);
  getRandomCharacter();
});
saveScoreForm.addEventListener('submit', function (e) {
  e.preventDefault();
  if (!username.value) return;
  (0, _firebase.saveScore)(highScoresArray, username.value, score);
});
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./firebase/firebase":"firebase/firebase.js","./auth/utils":"auth/utils.js","./utils/navigation":"utils/navigation.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
